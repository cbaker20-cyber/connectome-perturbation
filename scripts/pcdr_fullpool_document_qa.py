...
out=root/'exports/pcdr_research_record_20260922_fullpool';qa=out/'qa';qa.mkdir(exist_ok=True)
pdf=out/'Connectome_Research_Record_2026-09-22_Fullpool.pdf'
...
old={body(p):int(p.stem.split('-')[-1]) for p in (root/'exports/pcdr_research_record_20260922_design_audit/qa').glob('page-*.png')}
