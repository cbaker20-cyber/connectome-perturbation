...
out=root/'exports/pcdr_research_record_20260921_matching_audit';qa=out/'qa';qa.mkdir(exist_ok=True)
pdf=out/'Connectome_Research_Record_2026-09-21_Matching_Audit.pdf'
...
old={body(p):int(p.stem.split('-')[-1]) for p in (root/'exports/pcdr_research_record_20260921_completed/qa_release').glob('page-*.png')}
