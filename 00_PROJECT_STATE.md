...
- Standardized benchmark registry and evaluation framework for perturbation experiments. (done via `data/benchmark_registry.yaml`, `tools/validate_benchmarks.py`; see `docs/benchmark_evaluation_framework.md`)
